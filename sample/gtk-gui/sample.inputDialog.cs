...
namespace sample
{
	public partial class inputDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget sample.inputDialog
			this.Name = "sample.inputDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child sample.inputDialog.VBox
			...
			this.hbox1.Add (this.button26);
			global::Gtk.Box.BoxChild w4 = ((global::Gtk.Box.BoxChild)(this.hbox1 [this.button26]));
			w4.Position = 1;
			w4.Expand = false;
			w4.Fill = false;
			w1.Add (this.hbox1);
			...
			w5.Expand = false;
			w5.Fill = false;
			// Internal child sample.inputDialog.ActionArea
